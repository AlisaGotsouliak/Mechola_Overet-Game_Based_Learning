...
namespace template.Server.Data
{
	public class DbRepository
	{
        ...
        public async Task<int> InsertReturnIdAsyncGames(string query, object parameters = null)
        {
            try
            {
                OpenConnection();
        ...
        public async Task<int> InsertReturnIdAsyncQuestions(string query, object parameters = null)
        {
            try
            {
                OpenConnection();
